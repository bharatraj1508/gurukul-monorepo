...
export function NoticeModal({ editingNotice = null }: NoticeModalProps) {
  ...
  const defaultValues: Partial<FormValues> = editingNotice
    ...
    : {
        title: '',
        scope:
          scopeOptions.length > 0 && scopeOptions[0]
              ...
              <Controller
                ...
                render={({ field }) => (
                  <SearchableSelect
                    ...
                    value={field.value}
                    onChange={(val: string) =>
                      field.onChange(val as NoticeScope)
                    }
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <div className="relative">
                      {isLoadingClasses ? (
                        <div className="h-10 flex items-center px-3 text-sm text-zinc-500 border rounded-md">
                          Loading classes...
                        </div>
                      ) : (
