    ...
    <Modal
      ...
      description={
        <div className="flex items-center gap-2 mt-1">
          <Badge
            variant="outline"
            className={cn('border-none text-[10px]', scopeColors[notice.scope])}
          >
          ...
          <Badge
            variant="outline"
            className={cn(
              'border-none flex gap-1 text-[10px]',
              statusColors[status],
            )}
          >
      ...
      <div className="space-y-4">
        <div className="flex flex-wrap gap-x-6 gap-y-2 text-xs text-zinc-600 dark:text-zinc-400 pb-3 border-b border-zinc-200 dark:border-zinc-800">
          ...
          <div className="flex items-center gap-1.5">
            ...
            <span>
              Valid: {format(startDate, 'MMM d, yyyy h:mm a')} &rarr;{' '}
            ...
            <div className="pb-3 border-b border-zinc-200 dark:border-zinc-800">
              ...
              <div className="flex flex-wrap gap-1.5">
                {notice.classes.map((c) => (
                  <span
                    key={c.classId}
                    className="px-2 py-0.5 bg-zinc-100 dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 rounded-md text-xs"
                  >
